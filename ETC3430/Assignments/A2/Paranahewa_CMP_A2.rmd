...
m_future <- array(NA, c(age, year + 35, simulation_size))
k_future <- array(NA, c(year + 35, simulation_size))


for (z in 1:simulation_size) {
    m_future[1:age, 1:year, z] <- m[1:age, 1:year]
    k_future[1:year, z] <- k[1:year]
    for (t in 1:35) {
