...
for (model in models) {
    ...
    if (ets$AICc < min_AICc[2]) {
        min_AICc <- c(model, ets$AICc)
    }
}
glue("The model with the lowest AICc is a {min_AICc[1]} model, with an AICc of {min_AICc[2]}")
```
